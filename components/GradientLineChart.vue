<template>
  <apexchart
    v-if="is_mount"
    class="apexchart h-[212px] min-w-[651px]"
    type="bar"
    :height="height"
...
defineProps({
  ...
  chartOptions: {
    ...
    default: () => ({
      ...
      yaxis: {
        labels: {
          style: {
            colors: "#454545", // Specify the desired color here
            fontWeight: 500,
            fontSize: 14,
          },
        },
          ...
          return `
            <div class="relative">
              ...
              <div class="absolute top-0 left-0 space-y-[5px] -ml-[150px] -mt-16 w-[162px] py-[15px] overflow-hidden text-center">
                <h1 class="text-xs text-[#088178] font-medium">200+ buyurtma</h1>  
                <p class="text-sm font-bold">34.568.150 so‘m</p>
              </div>
            </div>`;
        },
      },
  ...
  series: {
    ...
    default: () => [
      {
        name: "Watts",
        data: [150, 230, 380, 220, 420, 200, 70, 150, 230, 380],
      },
    ],
  },
});
