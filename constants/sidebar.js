...
export const sidebar = [
    ...
    { id: 2, icon: products, icon1: products1, title: 'Mahsulotlar', path: "/products" },
    { id: 3, icon: profile, icon1: profile1, title: 'Profil', path: "/profile" },
    { id: 4, icon: comments, icon1: comments1, title: 'Sharhlar', path: "/comments" },
    { id: 5, icon: settings, icon1: settings1, title: 'Sozlamalar', path: "/settings" },
]